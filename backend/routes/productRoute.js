...
router.route("/admin/product/:id").put(isAuthenticationUser, authorizeRoles("admin"), updateProduct);      // admin ke liye
router.route("/admin/product/:id").delete(isAuthenticationUser, authorizeRoles("admin"),  deleteProduct);   // admin ke liye
